...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(in_channels=2, out_channels=32, kernel_size=9, stride=2, padding=4)
        self.conv2 = nn.Conv1d(in_channels=32, out_channels=32, kernel_size=7, stride=2, padding=3)
        self.conv3 = nn.Conv1d(in_channels=32, out_channels=32, kernel_size=5, stride=2, padding=2)
