...
# from Models.self_onn_SE import self_onn_SE
...
# seed_list = [4, 34, 40, 59, 67]
for i in range(3):
    batch_size = 10
    num_iters = 20000
    window_size = 10000
    # data_name = "gasf_mar_recurrence"
    # data_name = "ptbdb0402"
    # exp_name = "self-onn_Fcanet_ada16_64_19_mappar"
    # exp_name = "self-onn_unet"
    exp_name = "Selfonn_fcanet_ada2"
    # exp_name = "Self_ONN_fcanet_Adaptive_8"
    # exp_name = "self-onn_FECAM"
    # exp_name = "CNN"
    # SEED = 40
    ...
    # f"Selfonn_ada_results/ptbdb/{seed_num}/{exp_name}/{riqi}"
    # result_path = f"result_data/ptbdb/42/self-onn_SE/2025-04-12-23-58-47"

    train_data, val_data, test_data = gen_data(data_path, seed_num, chns=["ii", "v5"])
    # train_data,val_data,test_data = gen_data2(chns = ['vz', 'v6'])
    # data_path = r'result_data\ptbdb0409\data'

    # data_unhealthy_train = np.load(os.path.join(data_path, "mi_train.npy"),allow_pickle=True)
    # data_healthy_train = np.load(os.path.join(data_path, "hc_train.npy"),allow_pickle=True)
    # data_unhealthy_val = np.load(os.path.join(data_path, "mi_val.npy"),allow_pickle=True)
    # data_healthy_val = np.load(os.path.join(data_path, "hc_val.npy"),allow_pickle=True)
    # data_unhealthy_test = np.load(os.path.join(data_path, "mi_test.npy"),allow_pickle=True)
    # data_healthy_test = np.load(os.path.join(data_path, "hc_test.npy"),allow_pickle=True)
