...
class self_onn_fcanet_ada3(nn.Module):
    def __init__(self):
        super(self_onn_fcanet_ada3, self).__init__()
        ...
        self.onn4 = nn.Sequential(
            ...
            nn.Tanh(),
            nn.MaxPool1d(kernel_size=2, stride=2),
            MultiSpectralAttentionLayer(channel=64, dct_length=39, base_length=19, reduction=16, n = 16),
        )
        ...
        self.onn5 = nn.Sequential(
            ...
            nn.Tanh(),
            nn.MaxPool1d(kernel_size=2, stride=2),
            MultiSpectralAttentionLayer(channel = 64, dct_length=19, base_length=19,reduction=16, n = 16) 
        )
