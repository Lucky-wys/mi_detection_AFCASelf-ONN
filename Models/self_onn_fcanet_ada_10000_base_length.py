...
class self_onn_fcanet_ada_10000_base_length(nn.Module):
    def __init__(self):
        super(self_onn_fcanet_ada_10000_base_length, self).__init__()
        self.onn1 = nn.Sequential(

            SelfONN1d(in_channels=2, out_channels=32, kernel_size=3, padding=1,q=3),
            ...
            nn.Tanh(),
            nn.MaxPool1d(kernel_size=2, stride=2),
             MultiSpectralAttentionLayer(channel=32, dct_length=2500,base_length=39, reduction=16, n = 16), 
        )
        self.onn2 = nn.Sequential(
            ...
            nn.Tanh(),
            nn.MaxPool1d(kernel_size=2, stride=2),
            MultiSpectralAttentionLayer(channel=32, dct_length=625,base_length=39, reduction=16, n = 16), 
        )
        ...
        self.onn3 = nn.Sequential(
            ...
            MultiSpectralAttentionLayer(channel=32, dct_length=156,base_length=39, reduction=16, n = 16), 
        )
        self.onn4 = nn.Sequential(
            ...
            nn.Tanh(),
            nn.MaxPool1d(kernel_size=2, stride=2),
            MultiSpectralAttentionLayer(channel=32, dct_length=39,base_length=39, reduction=16, n = 16),
        )
...
if __name__ == '__main__':
    model = self_onn_fcanet_ada_10000_base_length()
