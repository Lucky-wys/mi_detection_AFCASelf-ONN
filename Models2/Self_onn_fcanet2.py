...
def get_freq_indices(method, length):
    ...
    if method.startswith("top"):
        num = int(method[3:])
        return indices[-num:]  # 返回最后 num 个索引
    elif method.startswith("low"):
        num = int(method[3:])
        return indices[:num]  # 返回前 num 个索引
...
class Self_onn_fcanet2(nn.Module):
    def __init__(self):
        super(Self_onn_fcanet2, self).__init__()
        ...
        self.onn1 = nn.Sequential(
            ...
            nn.Tanh(),
            nn.MaxPool1d(kernel_size=2, stride=2),
            # MultiSpectralAttentionLayer(32, dct_length=1250, freq_sel_method="low16"),
        )
        self.fcanet1 = MultiSpectralAttentionLayer(32, dct_length=1250, freq_sel_method="low16")
        self.onn2 = nn.Sequential(
            ...
            nn.Tanh(),
            nn.MaxPool1d(kernel_size=2, stride=2),
            # MultiSpectralAttentionLayer(32, dct_length=313, freq_sel_method="low16"),
        )
        self.fcanet2 = MultiSpectralAttentionLayer(32, dct_length=313, freq_sel_method="low16")
        ...
        self.onn3 = nn.Sequential(
            ...
            # MultiSpectralAttentionLayer(32, dct_length=78, freq_sel_method="low16"),
        )
        self.fcanet3 = MultiSpectralAttentionLayer(32, dct_length=78, freq_sel_method="low16")
        ...
        self.onn4 = nn.Sequential(
            ...
            nn.MaxPool1d(kernel_size=2, stride=2),
            #   FECAM(39),
            # MultiSpectralAttentionLayer(32, dct_length=19, freq_sel_method="low16"),
        )
        self.fcanet4 = MultiSpectralAttentionLayer(32, dct_length=19, freq_sel_method="low16")
