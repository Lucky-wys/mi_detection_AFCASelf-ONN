...
class Self_onn_fcanet_ada1(nn.Module):
    def __init__(self):
        super(Self_onn_fcanet_ada1, self).__init__()
        ...
        self.onn1 = nn.Sequential(
            ...
            nn.MaxPool1d(kernel_size=2, stride=2),
            # FECAM(2500),
            MultiSpectralAttentionLayer(channel=32, dct_length=1250, base_length=19, reduction=16, n=16),
        )
        self.onn2 = nn.Sequential(
            ...
            nn.MaxPool1d(kernel_size=2, stride=2),
            # FECAM(625),
            MultiSpectralAttentionLayer(channel=32, dct_length=313, base_length=19, reduction=16, n=16),
        )
        ...
        self.onn3 = nn.Sequential(
            ...
            MultiSpectralAttentionLayer(channel=32, dct_length=78, base_length=19, reduction=16, n=16),
        )
        ...
        self.onn4 = nn.Sequential(
            ...
            nn.MaxPool1d(kernel_size=2, stride=2),
            #   FECAM(39),
            MultiSpectralAttentionLayer(channel=32, dct_length=19, base_length=19, reduction=16, n=16),
        )
...
if __name__ == "__main__":
    model = Self_onn_fcanet_ada1()
    summary(model, (10, 2, 5000))
